...
if(NOT DOTNET_FOUND AND NOT DOTNET_CORE_FOUND AND NOT MONO_FOUND)
    if(CSBUILD_TOOL)
...
if(NOT CSHARP_TARGET_FRAMEWORK_VERSION)
    set(CSHARP_TARGET_FRAMEWORK_VERSION "4.8" CACHE STRING "C# .NET framework for msbuild and xbuild" )
endif()
if(NOT CSHARP_TARGET_FRAMEWORK)
    set(CSHARP_TARGET_FRAMEWORK "netcoreapp3.1" CACHE STRING "C# .NET framework for dotnet" )
endif()
